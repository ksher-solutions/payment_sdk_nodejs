...
class PaySDK extends SDK{
  ...
  static API = '/api/v1/bscanc/orders'
   ...
   * @param {string} data.channel               - channel customer pay
   * @param {string} data.auth_code             - Data read from customer QR
   * @param {string} data.mid                   - mid
